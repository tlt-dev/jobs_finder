...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form class="d-flex" method="post" action="index.php" name="formAuthentificationModal">
                <input type="hidden" name="gestion" value="authentification">

                <input type="submit" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalAuthentification" value="Login">
            </form>
        </div>
    </div>
</nav>
