...
class OffreObjet
{
    ...
    public function setOff_intitule($off_intitule){
        $off_intitule = $this->validation($off_intitule);
    ...
    public function setOff_ville($off_ville){
        $off_ville = $this->validation($off_ville);
    ...
    public function setOff_cp_ville($off_cp_ville){
        $off_cp_ville = $this->validation($off_cp_ville);
    ...
    public function setOff_date_prise_poste($off_date_prise_poste){
        $off_date_prise_poste = $this->validation($off_date_prise_poste);
    ...
    public function setOff_salaire($off_salaire){
        $off_salaire = $this->validation($off_salaire);
        if ($off_salaire < 0){
    ...
    public function setOff_duree($off_duree){
        $off_duree = $this->validation($off_duree);
    ...
    public function setOff_secteur_activite($off_secteur_activite){
        $off_secteur_activite = $this->validation($off_secteur_activite);
    ...
    public function setOff_descriptif($off_descriptif){
        $off_descriptif = $this->validation($off_descriptif);
    ...
    public function setOff_type_contrat($off_type_contrat){
        $off_type_contrat = $this->validation($off_type_contrat);
    ...
    public function setOff_poste($off_poste){
        $off_poste = $this->validation($off_poste);
